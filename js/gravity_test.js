...
scene.add( new THREE.AmbientLight( 0x666666 ) );
				...
				scene.add( light );
//땅
let mesh = new THREE.Mesh( new THREE.PlaneGeometry( 20000, 20000 ), new THREE.MeshPhongMaterial({ color: 'gray' }) );
				mesh.position.y = - 250;
...
//오브젝트
    ...
    const material = new THREE.MeshPhongMaterial({ color: 'sray' });
